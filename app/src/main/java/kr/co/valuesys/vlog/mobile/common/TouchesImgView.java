...
//            else if (this.getX() < 0 || this.getX() > parent_width) {
//                if (this.getX() < 0) {
//                    this.setX(0);
//                    this.setY(event.getRawY() - oldYvalue - this.getHeight());
//                } else {
//                    this.setX(parent_width);
//                    this.setY(event.getRawY() - oldYvalue - this.getHeight());
//                }
//            } else if (this.getY() < 0 || this.getY() > parent_height) {
//                if (this.getY() < 0) {
//                    this.setX(event.getRawX() - oldXvalue);
//                    this.setY(0);
//                } else {
//                    this.setX(event.getRawX() - oldXvalue);
//                    this.setY(parent_height);
